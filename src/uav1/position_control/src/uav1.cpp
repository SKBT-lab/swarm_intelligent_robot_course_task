...
int main(int argc, char **argv)
{
  ...
  controlCmd_pub = nh.advertise<quadrotor_msgs::PositionCommand>("/uav1/position_cmd", 10);
  ...
  waypoints.push_back(Eigen::Vector3d(10, 0, 1));
  waypoints.push_back(Eigen::Vector3d(13, 30, 1.5));
  waypoints.push_back(Eigen::Vector3d(17, -1, 3));
  waypoints.push_back(Eigen::Vector3d(29, 10, 5));
  waypoints.push_back(Eigen::Vector3d(36, 7, 4.5));
  waypoints.push_back(Eigen::Vector3d(30, 21, 3));
  waypoints.push_back(Eigen::Vector3d(13, -10, 3.5));
  waypoints.push_back(Eigen::Vector3d(-10, -30, 2.5));
  waypoints.push_back(Eigen::Vector3d(10, 0, 1));
